...
def handleShowList(client):
    ...
    for c in clients:
        ...
        message = ''
        if(connected_with):
            message = f"{counter},{c},{client_address},connected with{connected_with},qwerty,\n"
        else:
            message = f"{counter},{c},{client_address},Available,qwerty,\n"
...
def handleClient(client,client_name):
    ...
    banner1 = "welcome!! u are connected to the server"
...
def acceptConnections():
    ...
    while True:
        ...
        print(f"connection is established with {client_name} : {addr}")
